...
namespace Shell
{
    internal class Extractor
    {
        ...
        public static Stream ExtractCover(Stream mobiFile)
        {
            ...
            return new Extractor(mobiFile).Extract();
        }
        ...
        long ReadPdbRecordOffset(uint recordIndex)
        {
        ...
        uint? ReadExthRecord(long exthHeaderOffset, int exthRecordType)
        {
        ...
        uint ReadVariableLength(uint bytes)
        {
        ...
        void EnsureMagic(long offset, string magicString)
        {
